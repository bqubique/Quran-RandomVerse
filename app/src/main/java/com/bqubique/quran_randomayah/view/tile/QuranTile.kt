...
class QuranTile : androidx.wear.tiles.TileService() {
    ...
    override fun onResourcesRequest(
        ...
        val drawable: Int = when (Calendar.getInstance().get(Calendar.HOUR_OF_DAY)) {
                ...
                LayoutElementBuilders.Column.Builder()
                    .addContent(
                        LayoutElementBuilders.Text.Builder().setText(ayah.verse.verseKey)
                            ...
                            ).setFontStyle(LayoutElementBuilders.FontStyles.body2(deviceParameters)
                                .setWeight(LayoutElementBuilders.FONT_WEIGHT_BOLD).build()).build()
                    )
